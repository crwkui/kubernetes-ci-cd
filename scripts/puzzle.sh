...
docker build -t 192.168.50.39:32772/puzzle:$BUILD_TAG -f applications/puzzle/Dockerfile applications/puzzle

#Push the images
docker push 192.168.50.39:32772/puzzle:$BUILD_TAG
