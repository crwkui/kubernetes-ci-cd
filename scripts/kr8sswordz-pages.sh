...
docker build -t 192.168.50.39:32773/kr8sswordz:$BUILD_TAG -f applications/kr8sswordz-pages/Dockerfile applications/kr8sswordz-pages

#Push the images
docker push 192.168.50.39:32773/kr8sswordz:$BUILD_TAG
